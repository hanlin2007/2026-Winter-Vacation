...
>在暑假的时候，我就学习过python，也涉及到了与“面向对象”相关的内容，但因为使用得少，很多语法细节都出现了遗忘，在正式开始编写代码之前，我让AI生成了语法清单，对相关语法进行了复习，便于后续的Pytorch学习

==同时，在复习面向对象相关语法后，我还找了一个Lenet-5网络的实战代码，自己尝试对代码进行逐行解析，最后算是基本疏通了语法障碍（见本日志最后）==
# Python 面向对象
